...
import { Alert, AlertIcon, Button, Image, Box, Text, Modal, ModalOverlay, ModalContent, ModalHeader, ModalFooter, ModalBody,ModalCloseButton, useDisclosure, FormControl, FormLabel, Textarea,} from '@chakra-ui/react';
     ...
     {items.length < 1 && (<Alert status='warning'>
...

        {
            ...
            <>
                ...
                <Button mt="4" size='sm' colorScheme='pink' onClick={onOpen}>Order</Button>
