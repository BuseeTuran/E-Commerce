...
function NewProduct() {
  ...
  return <div>
    ...
    <Text fontSize="2xl" >Create Product</Text>
                        ...
                        <form onSubmit={handleSubmit} >
                            ...
                            <FormControl mt="4">
                                ...
                                {touched.description && errors.description && (
                                    <Text color='green.500'>{errors.description}</Text>
                                )}
                            </FormControl>
                            <FormControl mt="4">
                                ...
                                {touched.price && errors.price && (
                                    <Text color='green.500'>{errors.price}</Text>
                                )}
                            </FormControl>
                            <FormControl mt="4">
                                        ...
                                        <div>
                                            {
                                                ...
                                                <Button colorScheme='green' mt="5" onClick={() => arrayHelpers.push('')}>
                                                    Add a Photo
                                                </Button>
                                        </div>
                                    )}
